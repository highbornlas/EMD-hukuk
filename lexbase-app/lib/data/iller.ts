export const ILLER: { il: string; ilceler: string[] }[] = [
  {
    il: 'Adana',
    ilceler: [
  ...
  },
  {
    ...
    ilceler: [
      ...
      'Kızılören', 'Merkez', 'Sandıklı', 'Sinanpaşa', 'Sultandağı',
      'Şuhut',
    ],
  },
  {
  ...
  },
  {
    ...
    ilceler: [
      ...
      'İznik', 'Karacabey', 'Keles', 'Kestel', 'Mudanya', 'Mustafakemalpaşa',
  ...
  },
  {
    ...
    ilceler: [
      ...
      'Elbistan', 'Göksun', 'Nurhak', 'Onikişubat', 'Pazarcık',
      'Türkoğlu',
    ],
  },
  {
  ...
  },
  {
    ...
    ilceler: [
      ...
      'Merkez', 'Suşehri', 'Şarkışla', 'Ulaş', 'Yıldızeli',
      'Zara',
    ],
  },
  {
    ...
    ilceler: [
      ...
      'Malkara', 'Marmaraereğlisi', 'Muratlı', 'Saray', 'Süleymanpaşa',
      'Şarköy',
    ],
  },
  {
    ...
    ilceler: [
      ...
      'Pazar', 'Reşadiye', 'Sulusaray', 'Turhal', 'Yeşilyurt',
      'Zile',
    ],
  },
  {
